...
public:
  ...
  void operator()(Eigen::MatrixXd &dudt, const Eigen::MatrixXd &u,
...
#pragma omp parallel for
  ...
  void assert_valid_flux(const Mesh &mesh, int i, int k,
  ...
  EulerState computeFlux(const Eigen::MatrixXd &U, int i, int k,
                         const Mesh &mesh) const {
   ...
   */
  EulerState computeOutflowFlux(const Eigen::MatrixXd &U, int i, int k,
                                const Mesh &mesh) const {
   ...
   */
  EulerState computeReflectiveFlux(const Eigen::MatrixXd &U, int i, int k,
                                   const Mesh &mesh) const {
   ...
   */
  EulerState computeInteriorFlux(const Eigen::MatrixXd &U, int i, int k,
                                 const Mesh &mesh) const {
