...
template <int DiscretisationType> class JSONSnapshotWriter;

template <> class JSONSnapshotWriter<FVM> : public SnapshotWriter {
public:
  JSONSnapshotWriter(const Grid &grid, std::shared_ptr<Model> &model,
...
template <> class JSONSnapshotWriter<DG> : public SnapshotWriter {
public:
  JSONSnapshotWriter(const Grid &grid, std::shared_ptr<Model> &model,
